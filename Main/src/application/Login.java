...
public class Login extends Application implements EventHandler<ActionEvent> {
	...
	public void start(Stage primaryStage) throws Exception {
			...
			try {
				 ...
				 **/
					...
					AlertBox.display("Incorrect Log In",
							...
							+ "\n Please select the forgotten password option if your password is unknown, or the register option to create an account.");
				}
		...
		BackgroundImage myBI = new BackgroundImage(new Image(
				// C:\Users\Student\workspace\Trial\src\application\commercial-airline-pilot.jpg
				"file:///C:/Users/Student/workspace/Trial/src/application/commercial-airline-pilot.jpg"),
